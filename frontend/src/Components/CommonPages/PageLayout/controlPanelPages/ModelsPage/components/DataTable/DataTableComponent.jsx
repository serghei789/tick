...
const DataTableComponent = () => {
    const { models, isOpenEditModal, setIsOpenEditModal, setEditingModel, deleteModel } = useContext(ModelsContext);
    ...
    return (
        <Fragment>
            <div className='text-end'>
                <div className='btn btn-outline-primary' onClick={createHandler}>
                    Создать модель
                </div>
            </div>
            <DataTable
